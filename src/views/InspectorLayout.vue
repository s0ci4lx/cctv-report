  ...
  <div class="container mx-auto p-4 md:p-8">
    ...
    <div role="tablist" class="tabs tabs-boxed mb-8 shadow-lg bg-base-200">
      <RouterLink 
        ...
        :class="{ 'tab-active !bg-secondary !text-secondary-content font-semibold': isActive('/inspector/reports') }"
      >
        📊 รายงาน Log การตรวจสอบ
      </RouterLink>
      
      <RouterLink 
        to="/inspector/cameras" 
        role="tab" 
        class="tab tab-lg transition-all duration-300 hover:bg-base-300"
        :class="{ 'tab-active !bg-secondary !text-secondary-content font-semibold': isActive('/inspector/cameras') }"
      >
        🎥 รายการกล้องทั้งหมด
      </RouterLink>
    </div>
